(function (global, factory) {
  ...
  var _defaults = {
    ...
    instructionsPullToRefresh: '<img src="ajax-loader.gif" style="margin-bottom:7px;">',    // instructionsPullToRefresh: 'Pull down to refresh',
    instructionsReleaseToRefresh: '<img src="ajax-loader.gif" style="margin-bottom:7px;">', // instructionsReleaseToRefresh: 'Release to refresh',
    instructionsRefreshing: '<img src="ajax-loader.gif" style="margin-bottom:7px;">',       // instructionsRefreshing: 'Refreshing',
    refreshTimeout: 500,
